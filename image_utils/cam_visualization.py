...
def generate_cam(img_path,model,input_shape=(256,256),layer_name=None):
    ...
    last_conv_layer = model.get_layer(layer_name)#Esse é o nome do ultimo layer de convoluçõa da rede
